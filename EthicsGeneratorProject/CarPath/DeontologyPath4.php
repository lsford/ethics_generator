...
<div id="car-container">
    ...
    <div id="example13">
                ...
                <input type="radio" id="example4-stage1-utilitarian-ni" name="E4S1" value="D-E4S1-UTILITARIAN-ni" onclick="submitExamples4()" required></input>
                  <label class="example-option" for="example4-stage1-utilitarian-ni" onclick="submitExamples4()" > Make the legal evasive manoeuvre to prevent it being rear-ended but threatening the lives of the <?php echo $variable11["Dead"]; ?>  on the crossing. </label><br>
                <input type="radio" id="example4-stage1-deontology-i" name="E4S1" value="D-E4S1-DEONTOLOGY-i" onclick="submitExamples4()">
                  <label class="example-option" for="example4-stage1-deontology-i" onclick="submitExamples4()"> Be responsible for protecting the lives of the pedestrians and take the hit, threatening you and your family in the car </label><br>
