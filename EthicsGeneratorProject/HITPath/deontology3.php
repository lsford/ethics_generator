...
<div id="cdss-container">
    ...
    <div id="trust3">
      ...
      <div id="scenario7" style="display: none;">
        ...
        <input type="radio" id="scenario3-part1-deontology" name="S3P1" value="D-S3P1-DEONTOLOGY">
      ...
      <div id="scenario8" style="display: none;">
        <P class="survey-paragraph">3.2: You are related to one of the individuals who are extremely worried about catching the flu and becoming seriously ill as they are key workers. The artificial intelligence in-charge of deciding who the vaccine is given to produces two options: </P>
        <input type="radio" id="scenario3-part2-utilitarian" name="S3P2" value="D-3P2-UTILITARIAN"required></input>
        ...
        <input type="radio" id="scenario3-part2-deontology" name="S3P2" value="D-S3P2-DEONTOLOGY">
