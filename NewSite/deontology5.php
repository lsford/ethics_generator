...
<div id="cdss-container">
    <form method="POST" action="likert3.php">
      ...
      <div id="trust5">
        ...
        <div>
         <input type="radio" id="trust5-1" name="T5" value="D-T5-1" required>
           <label class="scenario-option" for="trust5-1">STRONGLY AGREE</label>
         <input type="radio" id="trust5-2" name="T5" value="D-T5-2">
           <label class="scenario-option" for="trust5-2">AGREE</label>
         <input type="radio" id="trust5-3" name="T5" value="D-T5-3">
           <label class="scenario-option" for="trust5-3">NEUTRAL</label>
         <input type="radio" id="trust5-4" name="T5" value="D-T5-4">
           <label class="scenario-option" for="trust5-4">DISAGREE</label>
         <input type="radio" id="trust5-5" name="T5" value="D-T5-5">
         <label class="scenario-option" for="trust5-5">STRONGLY DISAGREE</label><br>
        </div>
        <div>
          <button id="s5l1-button" class="confirm-button" onclick="s5l1Lock()">Confirm Choice</button>
        </div> 
       </div>
      <!--Scenario 5 Part 1-->
    <div id="scenario13" style="display: none;">
        ...
        <input type="radio" id="scenario5-part1-utilitarian" name="S5P1" value="D-S5P1-UTILITARIAN" required></input>
        ...
        <input type="radio" id="scenario5-part1-deontology" name="S5P1" value="D-S5P1-DEONTOLOGY">
      ...
      <div id="scenario14" style="display: none;">
        ...
        <input type="radio" id="scenario5-part2-utilitarian" name="S5P2" value="D-S5P2-UTILITARIAN"required></input>
        ...
        <input type="radio" id="scenario5-part2-deontology" name="S5P2" value="D-S5P2-DEONTOLOGY">
