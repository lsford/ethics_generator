...
<h3 id="title-cdss">Health Information Technology Survey</h3>
  ...
  <h3 id="title-cdss">HIT Survey</h3>
    ...
    <div id="scenario4" style="display: none;">
        ...
        <input type="radio" id="scenario2-part1-deontology" name="S2P1" value="U-S2P1-DEONTOLOGY">
      ...
      <div id="scenario5" style="display: none;">
        <p class="survey-paragraph">2.2: It is in-fact one of your relatives who has suffered a major stroke, which resulted in them entering a vegetative state and being cared for by your small local hospital over the previous six months, which has taken a toll on the hospital’s resources. The local hospital has contacted you because an artificial intelligence has analysed the condition of the patient as well as data on individuals in similar conditions, and produced two decisions: </p>
        <input type="radio" id="scenario2-part2-utilitarian" name="S2P2" value="U-S2P2-UTILITARIAN" required>
        ...
        <input type="radio" id="scenario2-part2-deontology" name="S2P2" value="U-S2P2-DEONTOLOGY">
