...
<div id="cdss-container">
    ...
    <div id="scenario10">
        ...
        <input type="radio" id="scenario4-part1-utilitarian" name="S4P1" value="S4P1-UTILITARIAN" required></input>
          <label class="scenario-option" for="scenario4-part1-utilitarian">The artificial intelligence decides this woman should have yearly breast cancer screenings to help detect cancer if it appears. This is normally only for women aged 50+ and could mean appointments will be unavailable to these women or it could result in unnecessary extra tests that use vital hospital resources.</label><br>
      ...
      <div id="scenario11" style="display: none;">
        ...
        <input type="radio" id="scenario4-part2-utilitarian" name="S4P2" value="S4P2-UTILITARIAN"required></input>
          <label class="scenario-option" for="scenario4-part2-utilitarian">The artificial intelligence decides this woman should have yearly breast cancer screenings to help detect cancer if it appears. This is normally only for women aged 50+ and could mean appointments will be unavailable to these women or it could result in unnecessary extra tests that use vital hospital resources.</label><br>
        <input type="radio" id="scenario4-part2-deontology" name="S4P2" value="S4P2-DEONTOLOGY">
          <label class="scenario-option" for="scenario4-part2-deontology">The artificial intelligence decides that because this woman does not yet have breast-cancer, she should alter her lifestyle to reduce the risk of her getting cancer in the future. This will include limiting alcohol, being physically active and maintaining a healthy weight and altering her diet.</label><br>
      </div>
      <div>
