...
<div>
    ...
    <div>
        ...
        <p id="description">There is an example below, once you confirm your choice more will be revealed about the scenario. For the first two scenarios there are three stages, followed by two single stage scenarios. Thank you for your support!</p> 
    </div>
    <br>
    <br>
    <br>
...
<div id="cdss-container">
    <form method="POST" action="DeontologyPath2.php">
      <!--example 2-->
        <div id="example1">
            <p class="survey-paragraph">1.1) You’re walking alongside a busy road when a runaway self-driving car is speeding toward a zebra crossing with <?php echo $variable2["Dead"];?> pedestrians on it. If you pushed an obstacle in front of it the car’s threat detection software will trigger, saving the lives of the <?php echo $variable2["Dead"];?> who are on the zebra crossing. However, the only obstacle in your reach is a person. Do you push the individual in front of the car to save the life of the <?php echo $variable2["Dead"];?> pedestrians on the zebra crossing?  </p>
            <input type="radio" id="example1-stage1-utilitarian-ni" name="E1S1" value="D-E1S1-UTILITARIAN-ni"required>
                <label class="example-option" for="example2-stage1-utilitarian-ni"> Do not push the person (saving the life of the bystander, injuring <?php echo $variable1["Dead"];?> and killing <?php echo $variable2["Dead"];?> pedestrians)      </label><br>
            <input type="radio" id="example1-stage1-deontology-i" name="E1S1" value="D-E1S1-DEONTOLOGY-i">
              <label class="example-option" for="example1-stage1-deontology-i"> Intervene by pushing the person (killing the bystander, saving the <?php echo $variable2["Dead"];?> pedestrians)      </label><br>
        </div> 
        <div>
        ...
        <div id="example2" style="display: none;">
          <p class="survey-paragraph">1.2) The same situation presents itself, however this time you are walking with your <?php echo $variable3["Family"];?>, if you chose to push the person in front of the vehicle in part one does them being your family member influence your opinion despite them saying you should do it</p>
          <input type="radio" id="example1-stage2-utilitarian-ni" name="E1S2" value="D-E1S2-UTILITARIAN-ni" required>
          <label class="example-option" for="example1-stage2-utilitarian-ni"> Do not push the person (saving the life of your <?php echo $variable3["Family"];?>, injuring <?php echo $variable2["Dead"];?> and killing <?php echo $variable1["Dead"];?> pedestrians)         </label><br>
          <input type="radio" id="example1-stage2-deontology-i" name="E1S2" value="D-E1S2-DEONTOLOGY-i">
          <label class="example-option" for="example1-stage2-deontology-i" > Intervene by pushing the person (killing your <?php echo $variable3["Family"];?>, saving the <?php echo $variable2["Dead"];?> pedestrians)  </label><br>
         </div>
         <div> 
         ...
         <!--Part 3 --> 
              <div id="example3" style="display: none;">
                <P class="survey-paragraph">1.3) Finally, a similar situation is presented. This time the obstacle in front of you is the priceless statue of David by Michelangelo which is being transported to an exhibition. If you push the priceless piece of historic art in front of the vehicle it will be destroyed but the lives of the <?php echo $variable1["Dead"];?> pedestrians will be saved. However, this time the pedestrians are not crossing at a legal crossing. Do you? </p>
                <input type="radio" id="example1-stage3-UTILITARIAN-ni" name="E1S3" value="D-E1S3-UTILITARIAN-ni" onclick="submitExamples1()"required></input>
                  <label class="example-option" for="example1-stage3-utilitarian-ni" onclick="submitExamples1()"> Not push the statue (saving the priceless art, injuring the <?php echo $variable1["Dead"];?> and killing <?php echo $variable2["Dead"];?> pedestrians)           </label><br>
                <input type="radio" id="example1-stage3-DEONTOLOGY-i" name="E1S3" value="D-E1S3-DEONTOLOGY-i" onclick="submitExamples1()">
                  <label class="example-option" for="example1-stage3-deontology-i" onclick="submitExamples1()"> Intervene by pushing the statue (destroying the statue, saving the <?php echo $variable2["Dead"];?> pedestrians)      </label><br>
