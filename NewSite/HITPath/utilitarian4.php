...
$_SESSION['Path2']=$_POST['path2'];//Utilitarian Path
...
<div id="cdss-container">
    ...
    <div id="scenario10" style="display: none;">
        ...
        <input type="radio" id="scenario4-part1-deontology" name="S4P1" value="U-S4P1-DEONTOLOGY">
      ...
      <div id="scenario11" style="display: none;">
        ...
        <input type="radio" id="scenario4-part2-utilitarian" name="S4P2" value="U-S4P2-UTILITARIAN"required></input>
        ...
        <input type="radio" id="scenario4-part2-deontology" name="S4P2" value="U-S4P2-DEONTOLOGY">
